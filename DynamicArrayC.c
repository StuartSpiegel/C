...
int main()
{
    ...
    //Write the array to the stack, dynamic assignment
    ...
    //if true --> were done and free the stack memory ALLOC
    if (total_number_of_books) {
        free(total_number_of_books);
    }
    //free the rest of the memory alloc on stack (the array) representing the shelves
    for (int i = 0; i < total_number_of_shelves; i++) {
